...
set CLASSPATH=%APP_HOME%\lib\MagicFolderRedesign-1.0-SNAPSHOT-all.jar

@rem Execute MagicFolderRedesign
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MAGIC_FOLDER_REDESIGN_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
